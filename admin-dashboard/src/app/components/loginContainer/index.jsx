...
const LoginContainer = () => {
  ...
  return (
    <div className='flex items-center w-full  justify-center'>
      <div className='absolute  mx-auto my-auto  border-gray-200 border-2 border-opacity-50 hover:border-4 hover:border-blue-200 hover:border-opacity-25 rounded-lg  inset-0 w-[30rem] h-[22rem] '>
